...
Revision ID: cae11b9a0e70
Revises: 
Create Date: 2021-11-22 20:06:26.788952
...
def upgrade():
    ...
    op.create_table('ranobe',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('title', sa.String(), nullable=False),
    sa.Column('url_main', sa.String(), nullable=False),
    sa.Column('url_chapter', sa.String(), nullable=False),
    sa.Column('text', sa.String(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('url_chapter'),
    sa.UniqueConstraint('url_main')
    )
